...
parser.add_argument('--seed', type=int, default=1111,
                    help='random seed')
parser.add_argument('--cuda-able', type=bool, default=False,help='enables cuda')

parser.add_argument('--save', type=str, default='./data/lstm-text-classfication/LSTM_Text.pt',
                    help='path to save the final model')
parser.add_argument('--data', type=str, default='./data/lstm-text-classfication/corpus.pt',
...
optimizer = AccSGD(rnn.parameters(), lr=args.lr)
