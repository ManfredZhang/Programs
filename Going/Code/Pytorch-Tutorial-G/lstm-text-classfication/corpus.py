...
if __name__ == "__main__":
    ...
    parser.add_argument('--file-path', type=str, default="./data/lstm-text-classfication/data",
                        help='file path')
    parser.add_argument('--save-data', type=str, default="./data/lstm-text-classfication/corpus.pt",
