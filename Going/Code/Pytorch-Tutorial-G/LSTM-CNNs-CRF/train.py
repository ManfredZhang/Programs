...
parser.add_argument('--seed', type=int, default=1111,
                    help='random seed')
parser.add_argument('--cuda-able', type=int, default=False,
                    help='enables cuda')
parser.add_argument('--lr', type=float, default=0.001,
                    help='learning rate')
parser.add_argument('--use-crf', type=int,default=False,
                    help='use crf')

parser.add_argument('--save', type=str, default='./data/LSTM-CNNs-CRF/lstm_cnns_crf.pt',
                    help='path to save the final model')
parser.add_argument('--save-epoch', type=int,default=False,
                    help='save every epoch')
parser.add_argument('--data', type=str, default='./data/LSTM-CNNs-CRF/corpus.pt',
