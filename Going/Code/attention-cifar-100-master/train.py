...
def train(args):
    ...
    train_set = torchvision.datasets.CIFAR100(root='./data/Template/cifar-100', train=True,
    ...
    val_set = torchvision.datasets.CIFAR100(root='./data/Template/cifar-10', train=False,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--architecture', type=str, default='resnet50_ca',
    ...
    parser.add_argument('--store_path', type=str, default='./data/trained_model',
